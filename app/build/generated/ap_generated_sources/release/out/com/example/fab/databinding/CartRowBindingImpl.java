...
public class CartRowBindingImpl extends CartRowBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.cartItem == variableId) {
            setCartItem((com.example.fab.models.CartItem) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setCartItem(@Nullable com.example.fab.models.CartItem CartItem) {
    ...
    protected void executeBindings() {
        ...
        com.example.fab.models.Product cartItemProduct = null;
        double cartItemProductPrice = 0.0;
        java.lang.String cartItemProductName = null;
        com.example.fab.models.CartItem cartItem = mCartItem;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.example.fab.models.Product.loadImage(this.productImageView, cartItemProductImageUrl);
            ...
            com.example.fab.models.CartItem.getSelectedSpinnerValue(this.quantitySpinner, cartItemQuantity);
        }
    }
