...
public class FragmentProductDetailBindingImpl extends FragmentProductDetailBinding implements com.example.fab.generated.callback.OnClickListener.Listener {
    ...
    private FragmentProductDetailBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback1 = new com.example.fab.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.shopViewModel == variableId) {
            setShopViewModel((com.example.fab.viewmodels.ShopViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setShopViewModel(@Nullable com.example.fab.viewmodels.ShopViewModel ShopViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeShopViewModelProduct((androidx.lifecycle.LiveData<com.example.fab.models.Product>) object, fieldId);
        }
        return false;
    }
    private boolean onChangeShopViewModelProduct(androidx.lifecycle.LiveData<com.example.fab.models.Product> ShopViewModelProduct, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        com.example.fab.viewmodels.ShopViewModel shopViewModel = mShopViewModel;
        ...
        androidx.lifecycle.LiveData<com.example.fab.models.Product> shopViewModelProduct = null;
        ...
        com.example.fab.models.Product shopViewModelProductGetValue = null;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            com.example.fab.models.Product.loadImage(this.productImageView, shopViewModelProductImageUrl);
